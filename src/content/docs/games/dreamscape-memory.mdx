...
<div class="not-content my-8">
  ...
  <div class="grid gap-4 sm:grid-cols-3">
    <figure class="overflow-hidden rounded-2xl border border-[var(--sl-color-hairline-shade)] bg-[var(--sl-color-bg-nav)]">
      <img
        src="/autopilot-page/images/dreamscape/chapter-1-clear.png"
    ...
    <figure class="overflow-hidden rounded-2xl border border-[var(--sl-color-hairline-shade)] bg-[var(--sl-color-bg-nav)]">
      <img
        src="/autopilot-page/images/dreamscape/chapter-2-clear.png"
    ...
    <figure class="overflow-hidden rounded-2xl border border-[var(--sl-color-hairline-shade)] bg-[var(--sl-color-bg-nav)]">
      <img
        src="/autopilot-page/images/dreamscape/chapter-3-clear.png"
