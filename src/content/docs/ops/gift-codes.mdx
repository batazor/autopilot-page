...
<div class="not-content my-6 rounded-2xl border border-[var(--sl-color-hairline-shade)] bg-[var(--sl-color-bg-sidebar)] p-6 shadow-sm">
  ...
  <div class="mt-4 flex flex-wrap gap-3">
    <a class="inline-flex items-center rounded-lg border border-[var(--sl-color-accent)] px-4 py-2 text-sm font-semibold text-[var(--sl-color-text-accent)] no-underline transition hover:bg-[var(--sl-color-accent-low)]" href="https://h5-res.wzqqe.com/land/index.html?invite=a1ia4w09" target="_blank" rel="noopener noreferrer">
...
<div class="not-content my-6 rounded-2xl border border-[var(--sl-color-accent)] bg-gradient-to-br from-[var(--sl-color-accent-low)] to-transparent p-6">
  ...
  <p class="m-0 text-sm text-[var(--sl-color-gray-3)]">
    Bulk-paste accepts <code>fid</code> or <code>fid label</code>, one per line. Scope is per game — WOS and Kingshot have independent lists.
  </p>
</div>
