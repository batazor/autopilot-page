...
<CardGrid>
  <Card title="Whiteout Survival" icon="list-format">
    Public WOS code sources plus Century's WOS redeem API.
  </Card>
  <Card title="Kingshot" icon="list-format">
    Kingshot code aggregator plus Century's Kingshot redeem API.
  </Card>
  <Card title="WOS Beta" icon="magnifier">
  ...
  <Card title="Kingshot Beta" icon="magnifier">
...
<div class="not-content my-6 rounded-2xl border border-[var(--sl-color-hairline-shade)] bg-[var(--sl-color-bg-sidebar)] p-6 shadow-sm">
  ...
  <div class="mt-4 flex flex-wrap gap-3">
    <a class="inline-flex items-center rounded-lg border border-[var(--sl-color-accent)] px-4 py-2 text-sm font-semibold text-[var(--sl-color-text-accent)] no-underline transition hover:bg-[var(--sl-color-accent-low)]" href="https://h5-res.wzqqe.com/land/index.html" target="_blank" rel="noopener noreferrer">
      Whiteout Survival beta
    </a>
    <a class="inline-flex items-center rounded-lg border border-[var(--sl-color-accent)] px-4 py-2 text-sm font-semibold text-[var(--sl-color-text-accent)] no-underline transition hover:bg-[var(--sl-color-accent-low)]" href="https://res.jxhk88.com/bbworld/index.html" target="_blank" rel="noopener noreferrer">
      Kingshot beta
    </a>
  </div>
</div>
...
<div class="not-content my-6 rounded-2xl border border-[var(--sl-color-accent)] bg-gradient-to-br from-[var(--sl-color-accent-low)] to-transparent p-6">
  ...
  <p class="m-0 text-sm text-[var(--sl-color-gray-3)]">
    Bulk-paste accepts <code>fid</code> or <code>fid label</code>, one per line. Scope is per game — WOS and Kingshot have independent lists. Requires an <strong>R3</strong> or higher license.
  </p>
</div>
