...
Open **Gift codes**, switch to either beta tab, and paste your Discord **bot token** into **Discord beta source** — that's the only field. The beta channels are built in, no IDs to configure.
