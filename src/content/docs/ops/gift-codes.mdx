...
<div class="not-content my-6 rounded-2xl border border-[var(--sl-color-hairline-shade)] bg-[var(--sl-color-bg-sidebar)] p-5 shadow-sm">
  <div class="mb-3 flex flex-wrap items-center justify-between gap-3">
    <div>
      ...
      <h3 class="m-0 mt-1 text-lg font-bold text-[var(--sl-color-white)]">Official beta code portals</h3>
    </div>
...
Then open **Gift codes**, switch to either beta tab, and fill **Discord beta source**:

- Bot token

WOS Beta uses the built-in Discord channel `1511081143083077652` from `https://discord.com/channels/1430936597477589114/1511081143083077652`.
Kingshot Beta uses the built-in Discord channel `1513031288695558285` from `https://discord.com/channels/1430936597477589114/1513031288695558285`.
