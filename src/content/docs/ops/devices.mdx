...
description: ADB dashboard — configured devices vs live scan, per-device capture and input backends (scrcpy / mintouch / quartz / adb), one-click backend install and screen reset.
sidebar:
  order: 1
  label: Devices (ADB)
---
